                ...
                <div class="col-md-3">
                    ...
                    <label>
                        <select class="form-control score" name="score">
                            ...
                            <option value="" <c:if test="${score eq ''}">selected</c:if>>无成绩</option>
                        </select>
                    </label>
                </div>
                  <div class="col-sm-3">
                    <label>性别：</label>
                    <label>
                      <select class="form-control sex"  name="">
                  ...
                  <div class="col-sm-6">
                    <label>年龄：</label>
                      <input type="text" name="" class="begin-age">
                       至 
                      <input type="text" name="" class="end-age"> 
                  </div>
              </div>
                  ...
                  <tr>
                      ...
                      <td>
                          <c:choose>
                              ...
                              <c:when test="${query.score == null or query.score eq ''}">无成绩</c:when>
                          </c:choose>
                      </td>
                  </tr>
              </c:forEach>
