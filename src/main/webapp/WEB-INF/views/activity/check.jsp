...
<div class=" container-widget">
                    ...
                    <tr data-id="${application.applicationId}">
                        ...
                        <td class="score-text">
                            <c:choose>
                                ...
                                <c:when test="${application.score eq ''}">无成绩</c:when>
                            </c:choose>
                        </td>
                        <td>
                            ...
                            <%--<c:if test="${activity.isFinish == -1}">--%>
                                ...
                                <a href="${pageContext.request.contextPath}/personal/permit/${application.applicationId}" class="btn btn-primary">查看入场证</a>
                            <%--</c:if>--%>
                        </td>
                    </tr>
                </c:forEach>
  ...
  <!-- End Row -->
      ...
      <button type="button" data-toggle="modal" data-target="#add" class="btn btn-success">管理员直通报名</button>
      <button type="button" data-toggle="modal" data-target="#all-grade" class="btn btn-primary">统一评定成绩</button>
      <a href="javascript:;" class="btn btn-info">统一下载入场证</a>
      <a href="javascript:;" class="btn btn-default">统一下载证书</a>
</div>
    <%--单人评定成绩--%>
        ...
        <div class="modal-dialog">
            <form class="modal-content" action="${pageContext.request.contextPath}/application/admin" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">管理员直通报名：</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group clearfix">
                        <label>用户名：</label>
                    ...
                    <div class="form-group clearfix">
                        <label>身份证：</label>
                        <input type="text" class="form-control require-text" name="idNumber">
                    </div>
                    <div class="form-group clearfix">
                        <label>联系电话：</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary pull-left" data-dismiss="modal">关闭</button>
                    <button type="submit" class="btn btn-success J-submit">直通报名</button>
                </div>
            </form>
            <!-- /.modal-content -->
        </div>
