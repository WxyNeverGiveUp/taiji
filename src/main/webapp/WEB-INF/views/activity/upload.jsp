    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <p>现使用默认入场证，如果需要改变入场证下载权限，请点击修改入场证下载权限！</p>
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#entry-pass">修改入场证下载权限</button>
        </div>
