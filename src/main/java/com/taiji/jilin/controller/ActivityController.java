...
//            }
    ...
    public String upload(@RequestParam("whoCertificate")String whoCertificate, Model model , @RequestParam("certificate") MultipartFile certificate, HttpServletRequest request, @RequestParam("id")int id) throws Exception {
        Activity activity = activityService.queryById(id);
